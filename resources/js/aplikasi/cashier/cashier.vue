...
export default {
  ...
  methods: {
    ...
    cekSound(a){
      ...
      var noLoket = new Audio(this.url+"/sound/"+a.loket+".wav") ;
      var keluar = new Audio(this.url+"/sound//in.wav");
      var masuk = new Audio(this.url+"/sound/out.wav");
      var sepuluh = new Audio(this.url+"/sound/sepuluh.wav");
      var sebelas = new Audio(this.url+"/sound/sebelas.wav");
      var puluh = new Audio(this.url+"/sound/puluh.wav");
      var ratus = new Audio(this.url+"/sound/ratus.wav");
      var seratus = new Audio(this.url+"/sound/seratus.wav");
      var suaraBelas = new Audio(this.url+"/sound/belas.wav");
      var NomorAntrian = new Audio(this.url+"/sound/nomor-urut.wav");
      var loket = new Audio(this.url+"/sound/loket.wav");

      if (noAntrian < 10) {
            var suara = new Audio(this.url+"/sound/"+noAntrian+".wav");
            masuk.play()
            setTimeout(function() {
              NomorAntrian.play();
              setTimeout(function () {
          ...
          return ;
            ...
            var suara = new Audio(this.url+"/sound/"+(noAntrian-10)+".wav");
            masuk.play()
            setTimeout(function() {
              NomorAntrian.play();
              setTimeout(function () {
            ...
            var angkapuluh = new Audio(this.url+"/sound/"+((noAntrian - (noAntrian % 10)) / 10)+".wav");
            var belakangpuluh = new Audio(this.url+"/sound/"+(noAntrian % 10)+".wav");
            if( (noAntrian % 10) == 0 ){
              var suara = new Audio(this.url+"/sound/"+(noAntrian-10)+".wav");
              masuk.play()
              setTimeout(function() {
